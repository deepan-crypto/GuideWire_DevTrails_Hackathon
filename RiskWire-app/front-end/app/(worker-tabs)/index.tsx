      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.row}>
          ...
          <View style={[styles.card, { flex: 1.2 }]}>
            ...
            <View style={styles.profileDetailsRow}><MapPin size={14} color="#666" /><Text style={styles.profileDetailText}>Urban</Text></View>
            <View style={styles.profileDetailsRow}><Briefcase size={14} color="#666" /><Text style={styles.profileDetailText}>Amazon</Text></View>
            <View style={styles.profileDetailsRow}><IndianRupee size={14} color="#666" /><Text style={styles.profileDetailText}>Avg Income ₹500/day</Text></View>
            <View style={styles.profileDetailsRow}><FileText size={14} color="#666" /><Text style={styles.profileDetailText}>POL-1773238789619-6557</Text></View>
          </View>
        ...
        <View style={styles.row}>
          <View style={[styles.card, { flex: 1 }]}>
            ...
            <View style={styles.statsGrid}>
              <View style={styles.statMiniBox}><Text style={styles.statMiniValue}>1</Text><Text style={styles.statMiniLabel}>Total</Text></View>
              <View style={styles.statMiniBox}><Text style={[styles.statMiniValue, { color: '#4CAF50' }]}>1</Text><Text style={styles.statMiniLabel}>Approved</Text></View>
        ...
        <View style={styles.row}>
          ...
          <View style={[styles.card, { flex: 1 }]}>
            ...
            <Text style={styles.updateText}>Updated 07:50 pm · auto-refreshes every 30s</Text>
            <View style={styles.disruptionAlert}>
              <MapPin size={12} color="#D32F2F" />
              <Text style={styles.disruptionAlertText}>Regional Weather Disruption — Heavy Rainfall</Text>
            </View>
          ...
          <View style={[styles.card, { flex: 1 }]}>
            ...
            {[
              { label: 'Total Claims', val: '1', color: '#1A1A24', bg: '#F0F4F8', icon: FileText },
              { label: 'Approved',     val: '1', color: '#4CAF50', bg: '#E8F5E9', icon: CheckCircle2 },
            ...
            <View style={styles.claimRowBorder}>
              ...
              <Text style={[styles.claimVal, { color: '#2196F3' }]}>₹350</Text>
            </View>
          </View>
        </View>
